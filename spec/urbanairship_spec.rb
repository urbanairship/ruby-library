...
shared_examples_for 'an Urbanairship client' do
  before(:all) do
    ...
    # register_device
    FakeWeb.register_uri(:put, 'https://my_app_key:my_app_secret@go.urbanairship.com/api/apids/new_device_token', status: %w(201 Created))
    FakeWeb.register_uri(:put, 'https://my_app_key:my_app_secret@go.urbanairship.com/api/device_tokens/new_device_token', status: %w(201 Created))
    FakeWeb.register_uri(:put, 'https://my_app_key:my_app_secret@go.urbanairship.com/api/device_tokens/existing_device_token', status: %w(200 OK))
    FakeWeb.register_uri(:put, 'https://my_app_key:my_app_secret@go.urbanairship.com/api/device_tokens/device_token_one', status: %w(201 Created))
    FakeWeb.register_uri(:put, /bad_key\:my_app_secret\@go\.urbanairship\.com/, status: %w(401 Unauthorized))
    ...
    FakeWeb.register_uri(:delete, /bad_key\:my_app_secret\@go\.urbanairship.com\/api\/device_tokens\/.+/, status: %w(401 Unauthorized))

    # device_info
    FakeWeb.register_uri(:get, /my_app_key\:my_app_secret\@go\.urbanairship.com\/api\/apids\/.+/, status: %w(200 OK), body: "{\"active\":true,\"alias\":null}")
    FakeWeb.register_uri(:get, /my_app_key\:my_app_secret\@go\.urbanairship.com\/api\/device_tokens\/.+/, status: %w(200 OK), body: "{\"active\":true,\"alias\":null}")
    FakeWeb.register_uri(:get, /bad_key\:my_app_secret\@go\.urbanairship.com\/api\/device_tokens\/.+/, status: %w(401 Unauthorized))

    # device_tokens
    FakeWeb.register_uri(:get, 'https://my_app_key:my_master_secret@go.urbanairship.com/api/device_tokens/', status: %w(200 OK), body: '{"device_tokens":[{"device_token": "0101F9929660BAD9FFF31A0B5FA32620FA988507DFFA52BD6C1C1F4783EDA2DB","active": false,"alias": null, "tags": []}], "device_tokens_count":50, "active_device_tokens_count":55}')
    FakeWeb.register_uri(:get, 'https://my_app_key2:my_master_secret2@go.urbanairship.com/api/device_tokens/', status: %w(401 OK))

    # push
    FakeWeb.register_uri(:post, 'https://my_app_key:my_master_secret@go.urbanairship.com/api/push/', status: %w(200 OK))
    FakeWeb.register_uri(:post, 'https://my_app_key2:my_master_secret2@go.urbanairship.com/api/push/', status: ['400', 'Bad Request'])
    FakeWeb.register_uri(:post, /bad_key\:my_master_secret\@go\.urbanairship\.com/, status: %w(401 Unauthorized))

    # batch_push
    FakeWeb.register_uri(:post, 'https://my_app_key:my_master_secret@go.urbanairship.com/api/push/batch/', status: %w(200 OK))
    FakeWeb.register_uri(:post, 'https://my_app_key2:my_master_secret2@go.urbanairship.com/api/push/batch/', status: ['400', 'Bad Request'])

    # broadcast push
    FakeWeb.register_uri(:post, 'https://my_app_key:my_master_secret@go.urbanairship.com/api/push/broadcast/', status: %w(200 OK))
    ...
    FakeWeb.register_uri(:delete, /bad_key\:my_master_secret\@go\.urbanairship.com\/api\/push\/scheduled\/[0-9]+/, status: %w(401 Unauthorized))

    # feedback
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/device_tokens\/feedback/, status: %w(200 OK), body: "[{\"device_token\":\"token\",\"marked_inactive_on\":\"2010-10-14T19:15:13Z\",\"alias\":\"my_alias\"}]")
    ...
    # tags
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags/, status: %w(200 OK), body: "[{\"tags\":[\"tag1\",\"tag2\"]}]")
    FakeWeb.register_uri(:get, /my_app_key2\:my_master_secret2\@go\.urbanairship.com\/api\/tags/, status: ['500', 'Internal Server Error'])

    # add_tag
    FakeWeb.register_uri(:put, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/new_tag/, status: %w(200 OK))
    FakeWeb.register_uri(:put, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/existing_tag/, status: %w(201 OK))
    ...
    # remove_tag
    FakeWeb.register_uri(:delete, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/non_deleted_tag/, status: %w(204 OK))
    FakeWeb.register_uri(:delete, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/deleted_tag/, status: %w(404 OK))
    ...
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/device_tokens\/valid_device_token\/tags/, status: %w(200 OK), body: "[{\"tags\":[\"tag1\",\"tag2\"]}]")
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/device_tokens\/invalid_device_token\/tags/, status: %w(404 OK))
    ...
    # #tag_device
    FakeWeb.register_uri(:post, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/new_tag/, status: %w(201 OK), body: '{"device_tokens":{"add":["valid_device_token"]}')
    FakeWeb.register_uri(:post, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/existing_tag/, status: %w(200 OK), body: '{"device_tokens":{"add":["valid_device_token"]}')
    ...
    # untag_device
    FakeWeb.register_uri(:post, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/existing_tag/, status: %w(204 OK),  body: '{"device_tokens":{"remove":["valid_device_token"]}')
    FakeWeb.register_uri(:post, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/tags\/non_existant_tag/, status: %w(404 OK), body: '{"device_tokens":{"remove":["valid_device_token"]}')
    ...
    # Get Segment
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/valid_id/, status: %w(200 OK), body: '{"display_name":"Male in NY", "criteria":{"and":[{"tag":"male"}, {"tag":"in NY"}]}}')
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/not_found/, status: %w(404 OK))
    ...
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments$/, status: %w(200 OK), body: '{"segments":[{"id":"abcd-efgh-ijkl", "display_name":"test1", "creation_date":1360950614201, "modification_date":1360950614201}, {"id": "mnop-qrst-uvwx", "display_name": "test2", "creation_date":1360950614202, "modification_date":1360950614202}]}')
    FakeWeb.register_uri(:get, /my_app_key2\:my_master_secret2\@go\.urbanairship.com\/api\/segments$/, status: ['500', 'Internal Server Error'])

    # Create Segment
    FakeWeb.register_uri(:post, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments/, status: %w(201 OK))
    ...
    # Update Segment
    FakeWeb.register_uri(:put, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/valid_segment/, status: %w(200 OK))
    FakeWeb.register_uri(:put, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/invalid_segment/, status: %w(404 OK))
    ...
    # Delete Segment
    FakeWeb.register_uri(:delete, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/valid_segment/, status: %w(204 OK))
    FakeWeb.register_uri(:delete, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/segments\/invalid_segment/, status: %w(404 OK))
    ...
    # push to segment
    FakeWeb.register_uri(:post, 'https://my_app_key:my_master_secret@go.urbanairship.com/api/push/segments', status: %w(200 OK))
    ...
    # device_tokens_count
    FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/device_tokens\/count/, status: %w(200 OK), body: "{\"device_tokens_count\":50, \"active_device_tokens_count\":55}")
  ...
  describe '::tags' do
    ...
    it 'raises an error if call is made without an app key and master secret configured' do
      ...
      lambda do
        subject.tags
      end.should raise_error(RuntimeError, 'Must configure application_key, master_secret before making this request.')
    end
  ...
  describe '::register_device' do
    ...
    it 'raises an error if call is made without an app key and secret configured' do
      ...
      end.should raise_error(RuntimeError, 'Must configure application_key, application_secret before making this request.')
    end
  ...
  describe '::delete_scheduled_push' do
    ...
    it 'sends the key that needs to be deleted' do
      subject.delete_scheduled_push(123_456_789)
      FakeWeb.last_request.path.should == '/api/push/scheduled/123456789'
    end
  ...
  describe '::push' do
    before(:each) do
      @valid_params = { device_tokens: %w(device_token_one device_token_two), aps: { alert: 'foo' } }
      subject.application_key = 'my_app_key'
      subject.master_secret = 'my_master_secret'
    end
    ...
    it 'converts aliases to strings' do
      ...
      request_json['aliases'].should == %w(one 2)
    end
  end
  ...
  describe '::batch_push' do
    before(:each) do
      @valid_params = [
        { device_tokens: %w(device_token_one device_token_two), aps: { alert: 'foo' } },
        { device_tokens: %w(device_token_three device_token_four), aps: { alert: 'bar' } }
      ]
      subject.application_key = 'my_app_key'
      subject.master_secret = 'my_master_secret'
    end
  ...
  describe '::segments' do
    ...
    it 'returns valid segments' do
      ...
      response['segments'].each do |s|
        %w(id display_name creation_date modification_date).each do |k|
          s.should include(k)
        end
      end
    end
