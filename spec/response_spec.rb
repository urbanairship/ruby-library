...
describe Urbanairship::Response do
  ...
  context 'body array accessor' do
    ...
    before do
      FakeWeb.register_uri(:get, /my_app_key\:my_master_secret\@go\.urbanairship.com\/api\/device_tokens\/feedback/, status: %w(200 OK), body: "[{\"device_token\":\"token\",\"marked_inactive_on\":\"2010-10-14T19:15:13Z\",\"alias\":\"my_alias\"},{\"device_token\":\"token2\",\"marked_inactive_on\":\"2010-10-14T19:15:13Z\",\"alias\":\"my_alias\"}]")
      Urbanairship.application_secret = 'my_app_secret'
      Urbanairship.application_key = 'my_app_key'
